# yoinked from https://github.com/Kurocon/Osu-Collections-Editor
# contains the stuff needed to parse collection.db and write a new collection.db

import logging
import struct

from db_format import get_int, get_string, get_uleb128, parse_string, parse_uleb128, print_as_bits
from db_format import OSU_BOOLEAN, OSU_BYTE, OSU_DOUBLE, OSU_INT, OSU_LONG, OSU_SHORT, OSU_SINGLE
from oce_models import Collections, Collection, CollectionMap, Difficulty2
